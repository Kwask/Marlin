...
#define STRING_CONFIG_H_AUTHOR "(kwask, Ender-5-SKR-mini-E3-V2.0)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.2, -3.37, -2.08 }
